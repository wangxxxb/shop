...
export function callpay(
    ...
    const onBridgeReadyExt = (...args) =>
        onBridgeReady.apply(this, [cb, ...args])
    ...
    if (typeof WeixinJSBridge == 'undefined') {
        if (document.addEventListener) {
            ...
            document.attachEvent('WeixinJSBridgeReady', onBridgeReadyExt)
            document.attachEvent('onWeixinJSBridgeReady', onBridgeReadyExt)
        }
        alert('需要在微信中进行支付！')
    } else {
        onBridgeReadyExt(
